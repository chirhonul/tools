...
# Whitelist the 127.0.0.1 -> tcp/8888 to tcp/8890 traffic (otherwise denied by default on Tails).
...
iptables -I OUTPUT -o lo -p tcp --dport 8890 -s 127.0.0.1/32 -d 127.0.0.1/32 -j ACCEPT

# On server side, start with:
# vncserver :0 -name d0 -geometry 1600x1200 -interface 127.0.0.1
